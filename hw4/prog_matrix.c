 ...
 * Revision 1.0 11.18.2021 22:41
 * LabX4
 *
 * Summary:
 * the program allocates memory using malloc depending on number of provided element for matrix of size NxN
 *
 * Syntax of run:
 * ./prog -s <N>
 */
...
int main(int argc, char *argv[]) {
        ...
        typedef struct mys {
                double m[num_elements][num_elements];
        } MysType;
